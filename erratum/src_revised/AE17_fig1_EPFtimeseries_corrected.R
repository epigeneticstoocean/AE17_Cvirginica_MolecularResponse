...
## Corrected Data
epf_exp <- read.csv("erratum/revised_data/AE17_EPFpHComplete.csv")
...
#pCO2_fac               0.58311 0.291554     2 14.854  4.9360 0.02272 *
#  Timepoint_fac        0.28274 0.056548     5 73.993  0.9574 0.44956  
...
# Type III Analysis of Variance Table with Satterthwaite's method
#                         Sum Sq Mean Sq NumDF  DenDF F value    Pr(>F)    
# pCO2_fac               1.57963 0.78981     2 14.881 13.2895 0.0004887 ***
# Timepoint_fac          0.44803 0.08961     5 74.017  1.5077 0.1977629    
# pCO2_fac:Timepoint_fac 1.15495 0.11549    10 74.009  1.9433 0.0523501 .  
...
pA <- ggplot(treatSeq_means,aes(x=Timepoint,y=EPF_pH,group=pCO2_fac,shape=pCO2_fac,colour=pCO2_fac)) +
   ...
   labs(x="Time (Days)",y=expression(paste(pH[EPF]," (Total)")),fill="") +
   theme_cowplot() +
...
pC <- plot_grid("",pA,"",pB,labels = c("A","","B",""),nrow=4,rel_heights = c(1.5,5,3,5))
pC
ggsave(pC,filename = "erratum/revised_results/Fig1_600dpi.png",width=11,height = 12,dpi = 600)
ggsave(pC,filename = "erratum/revised_results/Fig1_800dpi.png",width=11,height = 12,dpi = 800)
